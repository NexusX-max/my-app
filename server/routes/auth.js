...
// --- রেজিস্ট্রেশন পার্ট ---
// ফ্রন্টএন্ড কল করবে: fetch('/api/auth/register-options')
router.get('/register-options', generateRegistrationOptions);

// ফ্রন্টএন্ড কল করবে: fetch('/api/auth/verify-registration')
router.post('/verify-registration', verifyRegistration);


// --- লগইন পার্ট ---
// ফ্রন্টএন্ড কল করবে: fetch('/api/auth/login-options')
router.get('/login-options', generateAuthOptions);

// ফ্রন্টএন্ড কল করবে: fetch('/api/auth/verify-login')
router.post('/verify-login', verifyAuthentication);


/* ==========================================================
    🛰️ ৩. পাসওয়ার্ড রিকভারি (Recovery Protocol)
========================================================== */
...
// গুগলের সাইন-ইন পেজে নিয়ে যাওয়া
